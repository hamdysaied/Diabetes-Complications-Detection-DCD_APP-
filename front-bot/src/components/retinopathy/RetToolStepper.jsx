...
import EyeSideImage from "../../assets/ret/retina.png";
import RetinaImage from "../../assets/ret/retina-photo.png";
import PlaceholderImage from "../../assets/ret/placeholder.png";
import CheckIcon from "../../assets/ret/icons/tick-circle.svg";
import { ReactComponent as UploadIcon } from "../../assets/ret/icons/arrow-up-1.svg";
import { ReactComponent as DropzoneIcon } from "../../assets/ret/icons/gallery-add.svg";
...
import advice from "../../video/advice.mp4"
...
const RetToolStepper = ({ patientID }) => {
  ...
  const prediction = useMutation({
    ...
    mutationFn: async (file) => {
      ...
      const res = await axios.put(
        "http://127.0.0.1:5500/image/" + patientID,
        formData
      );
      return res.data;
    },
          ...
          <StyledStep label="Welcome">
            ...
            <div className="stepContent">
              <div className="textWrapper">
                <p>
                  <B weight={600}>Diabetic retinopathy</B> is the leading cause
                  of blindness in the working-age population of the developed
                ...
                <p>
                  ...
                  suffering from Diabectic Retinopathy using the power of
                  Machine Learning.
                </p>
              </div>
          ...
          <StyledStep label="Results" className="results">
            {result === "Normal" && (
              <>
                ...
                <p>
                  <B>Please advise patients to:</B>
                </p>
                <div className="stepContent !grid grid-cols-2">
                  <AdviceList />
                  <video controls autoPlay src={advice}></video>
                </div>
